...
def main(attack_name):
    ...
    logdir = output_path + "attack_sets/"
    try:
        os.mkdir(logdir)
    ...
    df_train.to_csv(logdir + str(df_size) + "_" + attack_name + "_train_set.csv", sep=',', index=False, mode='w',
                    line_terminator='\n',
                    encoding='utf-8')
    df_cv.to_csv(logdir + str(df_size) + "_" + attack_name + "_crossval_set.csv", sep=',', index=False, mode='w', line_terminator='\n',
                 encoding='utf-8')
    df_test.to_csv(logdir + str(df_size) + "_" + attack_name + "_test_set.csv", sep=',', index=False, mode='w', line_terminator='\n',
                   encoding='utf-8')


if __name__ == "__main__":
    attack_types = ["FTP-Patator",
                    "SSH-Patator",
                    "DoS-Hulk",
                    "DoS-GoldenEye",
                    "DoS-slowloris",
